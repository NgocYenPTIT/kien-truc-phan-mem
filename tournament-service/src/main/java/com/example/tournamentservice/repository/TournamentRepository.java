...
public interface TournamentRepository extends JpaRepository<Tournament, Long> {
    ...
    Page<Tournament> findByIdInAndNameContainingIgnoreCaseAndDeletedAtIsNull(List<Long> ids, String name, Pageable pageable);

    Page<Tournament> findByIdInAndDeletedAtIsNull(List<Long> ids, Pageable pageable);
}