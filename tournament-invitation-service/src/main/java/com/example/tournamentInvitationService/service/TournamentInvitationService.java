...
//        // TODO :4.lấy ra các giải đấu do mình tổ chức và mình mời người khác tham gia
    ...
    public TournamentJoin findJoinTournament(Long userId) {
        List<TournamentInvitation> list = this.tournamentInvitationRepository.findByUserIdAndStatus(userId, "ACCEPT");
